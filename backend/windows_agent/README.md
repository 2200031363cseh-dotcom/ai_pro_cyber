...
2. Install all dependencies from public PyPI (anthropic, openai, sounddevice, pyautogui, …)
3. Copy `.env.example` → `.env` and open it in Notepad
...
Open PowerShell **in the agent folder** (Shift + right-click in the folder →
